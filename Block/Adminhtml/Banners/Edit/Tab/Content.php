...
class Content extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        // Add products colunms layout field 

        $fieldset->addField(
            'products_layout',
            'select',
            [
                'label'    => __('Products Layout'),
                'title'    => __('Products Layout'),
                'name'     => 'products_layout',
                'required' => true,
                'options'  => $this->getProductsLayout(),
                'note'     => __('Choose how match products on row will display'),
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'note'  => __( 'Add your custom css class here'),
            ]
        );
    ...
    protected function getProductsLayout()
    {
        return [
            CustomRule::PRODUCTS_COLUMNS_FOUR => __('4 colunms'),
            CustomRule::PRODUCTS_COLUMNS_SIX => __('6 colunms'),
        ];
    }
