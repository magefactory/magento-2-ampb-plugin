...
class Banner extends Template
{
    ...
    public function getBannerCssClass() 
    {
        return $this->banner->getData('custom_css_class');
    }

    public function getBannerProductsLayout() 
    {
        return $this->banner->getData('products_layout');
    }
