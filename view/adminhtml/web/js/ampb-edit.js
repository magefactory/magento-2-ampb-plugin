    ...
    $.widget('mage.ampromobannerAddAttribute', {
        _create: function () {
            ...
            if ($('#ampromobanners_show_products')) {
                ...
                // Show - hide custom css class field
                function showCssClassField() {
                    if ($("#ampromobanners_show_products option:selected").val() == 0)
                        $(".field-products_layout").hide();
                    else
                        $(".field-products_layout").show();
                }
                showCssClassField();
